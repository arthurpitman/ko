...
To build an image, use [`pkg/build`](https://pkg.go.dev/github.com/arthurpitman/ko/pkg/build), and publish it with [`pkg/publish`](https://pkg.go.dev/github.com/arthurpitman/ko/pkg/publish).
...
import (
	...
	"github.com/arthurpitman/ko/pkg/publish"
)
